...
export default function BackgroundDecorations() {
  return (
    <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden opacity-40">
      <Image
        src={withBasePath("/images/bg-2.svg")}
        alt=""
      ...
      />
      <Image
        src={withBasePath("/images/bg-3.svg")}
        alt=""
      ...
      />
      <Image
        src={withBasePath("/images/bg-4.svg")}
        alt=""
      ...
      />
      <Image
        src={withBasePath("/images/bg-5.svg")}
        alt=""
      ...
      />
      <Image
        src={withBasePath("/images/bg-6.svg")}
        alt=""
      ...
      />
      <Image
        src={withBasePath("/images/bg-7.svg")}
        alt=""
      ...
      />
      <Image
        src={withBasePath("/images/bg-8.svg")}
        alt=""
